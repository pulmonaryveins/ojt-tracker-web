    ...
    >
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          {breaks.map((brk, idx) => (
            <motion.div
              ...
              style={{ backgroundColor: 'var(--bg-modifier)', borderRadius: '0.5rem', padding: '1rem' }}
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                  <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>Break Start</label>
                  <TimePicker
                    value={brk.start}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.375rem' }}>
                  <label style={{ fontSize: '0.75rem', color: 'var(--text-muted)', fontWeight: 600 }}>Break End</label>
                  <TimePicker
                    value={brk.end}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <label style={{ fontSize: '0.75rem', fontWeight: 700, color: 'var(--text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Daily Images <span style={{ color: 'var(--text-muted)', fontWeight: 500, textTransform: 'none', fontSize: '0.75rem' }}>(optional)</span>
            </label>
          </div>
          <input
            ref={fileInputRef}
        ...
        <div style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '0.5rem', overflow: 'hidden' }}>
          ...
          >
            <span>
              Journal Entry <span style={{ color: 'var(--text-muted)', fontWeight: 400, fontSize: '0.8125rem' }}>(optional)</span>
            </span>
          ...
          {showJournal && (
            <div style={{ padding: '0 1rem 1rem' }}>
              <textarea
                ...
                onBlur={onBlur}
              />
              <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '0.5rem', margin: '0.375rem 0 0' }}>
                You can also edit this later from the session detail view.
              </p>
            </div>
          )}
        </div>
